...
def train_nb():
    ...
    joblib.dump(classifier, 'models/nb_model.joblib')
    joblib.dump(vectorizer, 'models/nb_vectorizer.joblib')
    print("Naive Bayes model saved to models/nb_model.joblib")
